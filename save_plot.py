...
def plot_scores(scores, title, display=False):
    ...
    plt.ylim([np.min(filtered_scores) - 1, np.max(filtered_scores) + 1])  # Adjust y-axis limits for better visualization
    plt.xlabel('Episode')
    plt.ylabel('Score')
...
if __name__ == "__main__":
    positions = [[-0.57500000, -0.57500000, 0.00000000],
                 [-0.57500000, 0.57500000, -1.15000000],
                 [-1.72500000, 0.57500000, 0.00000000],
                 [-0.57500000, 0.57500000, 1.15000000],
                 [-0.57500000, 1.72500000, 0.00000000],
                 [0.57500000, -0.57500000, -1.15000000],
                 [0.57500000, -1.72500000, 0.00000000],
                 [0.57500000, -0.57500000, 1.15000000],
                 [1.72500000, -0.57500000, 0.00000000],
                 [0.57500000, 0.57500000, -2.30000000],
                 [0.57500000, 1.72500000, -1.15000000],
                 [1.72500000, 0.57500000, -1.15000000],
                 [0.57500000, 0.57500000, 0.00000000],
                 [0.57500000, 1.72500000, 1.15000000],
                 [1.72500000, 0.57500000, 1.15000000],
                 [0.57500000, 0.57500000, 2.30000000]]
    positions = read_npy(op.join(script_dir,op.join('references','reference_5_B.xyz')))
